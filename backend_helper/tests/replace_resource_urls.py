...
ffi = cffi.FFI()
ffi.cdef('''
    unsigned int replace_resource_urls(const char *content, char *ret_buf, unsigned int ret_buf_size);
...
for i in range(call_count):
    lib.replace_resource_urls(content, ret_buf, 16384)

end_time = time.time()

print(ffi.string(ret_buf))
